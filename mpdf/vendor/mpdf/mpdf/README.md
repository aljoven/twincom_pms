...
By default, the temporary directory will be inside vendor1 directory and will have correct permissions from
...
To execute tests, run `vendor1/bin/phpunit` from the command line while in the mPDF root directory.
